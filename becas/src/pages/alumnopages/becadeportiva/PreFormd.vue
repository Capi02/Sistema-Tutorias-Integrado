<template>
  <q-page class="q-pa-md container" padding>
    <p class="title">Beca Deportiva</p>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      try {
        const response = await axios.get("http://127.0.0.1:3000/api/becas/3");
      ...
      if (accept !== true) {
        ...
        axios
          ...
          .then((res) => {
            ...
            router.push("/alumno/deportiva/socio");
          })
          .catch((error) => {
