<template>
  <q-page class="q-pa-md container" padding>
    <p class="title">Beca Postgrado</p>
      ...
      <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
        <div class="row">
          ...
          <q-input
            ...
            hint="Si es que no cuenta con uno escriba NA"
            class="col-5 q-pt-lg"
          />
          <q-space />
          <q-input
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      try {
        const response = await axios.get("http://127.0.0.1:3000/api/becas/7");
      ...
      if (accept !== true) {
        ...
        axios
          ...
          .then((res) => {
            ...
            router.push("/alumno/postgrado/socio");
          })
          .catch((error) => {
