<template>
  ...
  <div class="q-pa-md row items-start q-gutter-md">
    <p class="q-mb-sm">
      Esta es la pagina para habilitar o deshabilitar becas, cuando una beca este disponible busque la beca y seleccione "Si"
      en caso de que este disponible ese cuatrimestre.
    </p>
    <p class="q-mb-sm">
      En caso de que la beca no este seleccione "No"
    </p>
  ...
  props: {
   ...
   setup (props) {
    ...
    const formDataArray = ref([]);
     ...
     const disponibilidadOptions = ['Sí', 'No'];
